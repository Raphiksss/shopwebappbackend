...
async def update_user_partial(new_user:UserPartialUpdate,user:User, session:AsyncSession):
    for name,value in new_user.model_dump(exclude_none=True,exclude_unset=True).items():
