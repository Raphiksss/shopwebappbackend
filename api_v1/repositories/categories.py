...
async def category_partial_update(category:Category,new_category:CategoryPartialUpdate,session:AsyncSession):
    for name,value in new_category.model_dump(exclude_unset=True,exclude_none=True).items():
