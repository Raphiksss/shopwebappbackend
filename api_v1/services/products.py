...
async def create_product(
    data: ProductCreate, image_url: str, data_url: str, session: AsyncSession
) -> ProductRead:
...
async def partial_update_product(
    product_id: int,
    new_products_data: ProductUpdateStrings,
    image_url: str | None,
    data_url: str | None,
    ...
    product = await prod_repo.partial_update_product(
        session=session, product=product, new_product=updated_product
    )
